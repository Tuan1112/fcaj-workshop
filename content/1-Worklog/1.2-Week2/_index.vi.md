...
* Hiểu các khái niệm của **RDS**: engine, Multi-AZ, backup tự động.
* Nắm được cách **Lightsail** đơn giản hóa việc khởi tạo VM cho các workload nhỏ.
* Cấu hình chính sách **EC2 Auto Scaling** để tự động điều chỉnh capacity theo nhu cầu.
* Thiết lập metrics, dashboard và alarm trên **CloudWatch** để giám sát tình trạng tài nguyên.